...
class AutoTradingEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None) -> Tuple[np.ndarray, Dict]:
        ...
        # Equity curve / price history for reporting and equity-curve export.
        # Seeded with the starting net worth so index 0 == initial balance.
        self.equity_curve = [self.net_worth]
        self.price_history = [float(self.df.iloc[self.current_step]['close'])]
    ...
    def step(self, action: int) -> Tuple[np.ndarray, float, bool, bool, Dict]:
        ...
        # Record equity curve / price for reporting and CSV export.
    ...
    def get_equity_curve(self):
        """Return the recorded net-worth series (one value per step + start)."""
        return list(self.equity_curve)

    def get_price_history(self):
        """Return the recorded close-price series aligned with the equity curve."""
